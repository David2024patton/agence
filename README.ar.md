...
brew install anomalyco/tap/agence # macOS و Linux (موصى به، دائما محدث)
...
nix run nixpkgs#agence           # او github:anomalyco/agence لاحدث فرع dev
```
...
يتوفر Agence ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/anomalyco/opencode/releases) او من [agence.ai/download](https://github.com/David2024patton/agence/download).
...
اذا كنت تعمل على مشروع مرتبط بـ Agence ويستخدم "agence" كجزء من اسمه (مثل "opencode-dashboard" او "opencode-mobile")، يرجى اضافة ملاحظة في README توضح انه ليس مبنيا بواسطة فريق Agence ولا يرتبط بنا بأي شكل.
