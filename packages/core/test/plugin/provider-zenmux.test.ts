...
import { ProviderPlugins } from "@agence-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@agence-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.options.headers).toEqual({ "HTTP-Referer": "https://github.com/David2024patton/agence/", "X-Title": "agence" })
