...
Practical reference for the current tool-migration state in `packages/agence`.
...
Tool tests should use the existing Effect helpers in `packages/agence/test/lib/effect.ts`:
