import type { JsonSchema, LLMRequest, ProviderMetadata } from "@agence-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@agence-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @agence-ai/llm request objects from agence's session/AI SDK-shaped data.
  return LLM.request({
