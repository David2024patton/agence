...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@agence-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@agence/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.AGENCE_FAKE_VCS)
