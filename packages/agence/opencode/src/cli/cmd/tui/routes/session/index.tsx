...
import { AGENCE_BASE_MODE, useBindings, useCommandShortcut, useOpencodeKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["agence", "opencode-go"])
  ...
  createEffect(() => {
    ...
    return exit.message.set(
      [
        ...
        `  ${weak("Continue")}${UI.Style.TEXT_NORMAL_BOLD}agence -s ${session()?.id}${UI.Style.TEXT_NORMAL}`,
        ``,
      ].join("\n"),
    )
  })
