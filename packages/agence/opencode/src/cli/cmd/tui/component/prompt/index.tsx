...
import type { AssistantMessage, FilePart, UserMessage } from "@agence-ai/sdk/v2"
...
import { AGENCE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOpencodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.AGENCE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
