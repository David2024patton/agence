...
} from "@agence-ai/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@agence-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@agence-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@agence-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@agence-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@agence-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@agence-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "agence"
const DEFAULT_PACK_ID = "agence.default"
