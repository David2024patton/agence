...
const WORKFLOW_FILE = ".github/workflows/agence.yml"
        ...
        function printNextSteps() {
          ...
          prompts.outro(
            [
              ...
              "",
              "   Learn more about the GitHub agent - https://github.com/David2024patton/agence/docs/github/#usage-examples",
            ].join("\n"),
          )
        }
...
jobs:
  agence:
    if: |
      ...
      startsWith(github.event.comment.body, '/agence')
...
export const GithubRunCommand = effectCmd({
  ...
  handler: Effect.fn("Cli.github.run")(function* (args) {
    ...
    yield* Effect.promise(async () => {
      ...
      const shareBaseUrl = isMock ? "https://dev.opencode.ai" : "https://github.com/David2024patton/agence"
      ...
      try {
        ...
        console.log("agence session", session.id)
      ...
      async function getUserPrompt() {
        ...
        const mentions = (process.env["MENTIONS"] || "/agence,/oc")
          .split(",")
      ...
      async function chat(message: string, files: PromptFiles = []) {
        console.log("Sending message to agence...")
      ...
      function footer(opts?: { image?: boolean }) {
        ...
        const shareUrl = shareId ? `[agence session](${shareBaseUrl}/s/${shareId})&nbsp;&nbsp;|&nbsp;&nbsp;` : ""
    ...
    issue(number: $number) {
      ...
      function buildPromptDataForIssue(issue: GitHubIssue) {
        ...
        return [
          ...
          "- Git push and PR creation are handled AUTOMATICALLY by the agence infrastructure after your response",
