 ...
 *   "@agence/ServerAuthConfig",
 *   {
 *     password: Config.string("AGENCE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("AGENCE_SERVER_USERNAME").pipe(Config.withDefault("agence")),
 *   },
 * ) {}
 *
