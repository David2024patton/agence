...
export class Service extends Context.Service<Service, Interface>()("@agence/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        AGENCE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        AGENCE_WORKSPACE_ID: config.id,
        AGENCE_EXPERIMENTAL_WORKSPACES: "true",
