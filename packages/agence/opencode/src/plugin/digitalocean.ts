import type { Hooks, PluginInput } from "@agence-ai/plugin"
import type { Model } from "@agence-ai/sdk/v2"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Agence - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to Agence."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              ...
              instructions:
                "Sign in to DigitalOcean in your browser. Agence will create a Model Access Key named opencode-oauth-* and load your Inference Routers. Re-run /connect to refresh routers later.",
