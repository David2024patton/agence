...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=agence` lets xAI attribute opencode-originated
...
<html>
  <head>
    <title>Agence - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to Agence.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>Agence - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire agence process. Matches the silent-
