...
import type { QuestionRequest } from "@agence-ai/sdk/v2"
import {
...
function model(input: {
  ...
  return {
    ...
    api: {
      id: "agence",
      url: "https://github.com/David2024patton/agence",
...
test("direct model panel renders current model selector", async () => {
  ...
  const [current] = createSignal<RunInput["model"]>({ providerID: "agence", modelID: "gpt-5" })
