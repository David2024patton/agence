...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/agence.git")).toEqual({ owner: "sst", repo: "agence" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/agence")).toEqual({ owner: "sst", repo: "agence" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/agence.git")).toEqual({ owner: "sst", repo: "agence" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/agence")).toEqual({ owner: "sst", repo: "agence" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/agence.git")).toEqual({ owner: "sst", repo: "agence" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/agence")).toEqual({ owner: "sst", repo: "agence" })
})
