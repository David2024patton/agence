...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AGENCE_CALLER", () => {
    process.env["AGENCE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AGENCE_CALLER", () => {
    process.env["AGENCE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AGENCE_CALLER", () => {
    process.env["AGENCE_CALLER"] = "unknown"
