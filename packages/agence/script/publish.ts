...
const image = "ghcr.io/anomalyco/agence"
...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "url='https://github.com/anomalyco/agence'",
    "arch=('aarch64' 'x86_64')",
    "license=('MIT')",
    "provides=('agence')",
    "conflicts=('agence')",
    ...
    "",
    "package() {",
    '  install -Dm755 ./agence "${pkgdir}/usr/bin/agence"',
    "}",
    "",
  ].join("\n")
  ...
  const homebrewFormula = [
    ...
    `  homepage "https://github.com/anomalyco/agence"`,
  ...
  await Bun.file("./dist/homebrew-tap/agence.rb").write(homebrewFormula)
  await $`cd ./dist/homebrew-tap && git add agence.rb`
