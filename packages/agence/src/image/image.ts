...
export class Service extends Context.Service<Service, Interface>()("@agence/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __AGENCE_PHOTON_WASM_PATH?: string }).__AGENCE_PHOTON_WASM_PATH =
