import { Slug } from "@agence-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@agence-ai/llm"
...
import { NonNegativeInt, optionalOmitUndefined } from "@agence-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".agence", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@agence/Session") {}
