...
import { AgentAttachment, FileAttachment, ReferenceAttachment, Source } from "@agence-ai/core/session-prompt"
...
export class Service extends Context.Service<Service, Interface>()("@agence/SessionPrompt") {}
