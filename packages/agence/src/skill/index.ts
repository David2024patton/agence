...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, AGENCE_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@agence/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_AGENCE_SKILL_NAME] = {
          name: CUSTOMIZE_AGENCE_SKILL_NAME,
