...
import { optionalOmitUndefined } from "@agence-ai/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@agence-ai/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
    ...
    "amazon-bedrock": Effect.fnUntraced(function* () {
      ...
      return {
        ...
        async getModel(sdk: any, modelID: string, options?: Record<string, any>) {
          ...
          // 1. options.region from agence.json provider config
      ...
      if (!apiToken) {
        throw new Error(
          "CLOUDFLARE_API_TOKEN (or CF_AIG_TOKEN) is required for Cloudflare AI Gateway. " +
            "Set it via environment variable or run `agence auth cloudflare-ai-gateway`.",
        )
      }
...
export class Service extends Context.Service<Service, Interface>()("@agence/Provider") {}
