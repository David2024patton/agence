...
import type { Event, GlobalEvent, OpencodeClient } from "@agence-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@agence/RunStreamTransport") {}
