...
import { ensureProcessMetadata } from "@agence-ai/core/util/opencode-process"
...
const cli = yargs(args)
  ...
  .middleware(async (opts) => {
    ...
    process.env.AGENCE_PID = String(process.pid)

    Log.Default.info("agence", {
    ...
    const marker = path.join(Global.Path.data, "agence.db")
