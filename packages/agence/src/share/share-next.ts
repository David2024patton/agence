import type * as SDK from "@agence-ai/sdk/v2"
...
const disabled = process.env["AGENCE_DISABLE_SHARE"] === "true" || process.env["AGENCE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@agence/ShareNext") {}
