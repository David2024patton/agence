...
export default new Hono<{ Bindings: Env }>()
  ...
  /**
   * Used by the GitHub action to get GitHub installation access token given user PAT token (used when testing `agence github run` locally)
   */
  ...
  /**
   * Used by the agence CLI to check if the GitHub app is installed
   */
