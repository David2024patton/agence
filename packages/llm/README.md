...
Schema-first LLM core for agence. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@agence-ai/llm"
import { OpenAI } from "@agence-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@agence-ai/llm/providers"
