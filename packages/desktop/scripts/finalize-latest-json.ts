...
const releaseId = process.env.AGENCE_RELEASE
if (!releaseId) throw new Error("AGENCE_RELEASE is required")

const version = process.env.AGENCE_VERSION
if (!version) throw new Error("AGENCE_VERSION is required")
