export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Agence",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Agence. ¿Quieres instalarla y reiniciar?",
