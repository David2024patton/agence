...
const api: ElectronAPI = {
  ...
  getExternalServerConfig: () => ipcRenderer.invoke("get-external-server-config"),
  setExternalServerConfig: (config) => ipcRenderer.invoke("set-external-server-config", config),
