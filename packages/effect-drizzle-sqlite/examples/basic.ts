...
class Database extends Context.Service<Database, DatabaseShape>()("@agence/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@agence/example/UserStore") {
