...
Agent Skill let agence discover reusable instruction from your repo 또는 홈 디렉토리.
...
Project-local paths의 경우, agence는 git worktree에 도달 할 때까지 현재 작업 디렉토리에서 걷습니다.
...
agence는 `skill` 도구 설명에서 사용할 수있는 기술을 나열합니다.
