---
title: LSP-servere
description: Agence integreres med dine LSP-servere.
---

Agence integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Agence leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `AGENCE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når agence åbner en fil, vil den:
