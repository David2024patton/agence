---
title: TUI
description: Brug af Agence-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Agence giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Agence starter TUI for den nuværende mappe.
...
Når du bruger Agence TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Agence. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Agence. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor længe Agence venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `agence.default`.
