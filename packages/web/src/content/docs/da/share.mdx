---
title: Deling
description: Del dine Agence-samtaler.
---

Agences delingsfunksjon lar deg lage offentlige lenker til dine Agence-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Agence:
...
Agence støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Agence manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
[Finn ut mer](/docs/enterprise) om brug av agence i organisasjonen din.
