...
Agent skills let Agence discover reusable instructions from your repo or home directory.
...
Agence searches these locations:
...
For project-local paths, Agence walks up from your current working directory until it reaches the git worktree.
...
Agence lists available skills in the `skill` tool description.
