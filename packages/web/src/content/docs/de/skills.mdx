...
Agent Skills erlauben Agence, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
Agence sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft Agence vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
Agence listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
