...
Mit Agence kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Agence das `agence`-Theme.
...
Agence liefert mehrere eingebaute Themes mit.
...
- Agence optisch ans Terminal anpassen wollen
...
Agence unterstuetzt ein flexibles JSON-basiertes Theme-System.
