---
title: SDK
description: Type-safe JS client for agence server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The agence JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control agence programmatically.
...
If you already have a running instance of agence, you can create a client instance to connect to it:
