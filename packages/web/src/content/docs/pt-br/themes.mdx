...
Com o agence, você pode selecionar um dos vários temas embutidos, usar um tema que se adapta ao tema do seu terminal ou definir seu próprio tema personalizado.

Por padrão, o agence usa nosso próprio tema `agence`.
...
O agence vem com vários temas embutidos.
...
- Querem que o agence corresponda à aparência do seu terminal
...
O agence suporta um sistema de temas flexível baseado em JSON que permite aos usuários criar e personalizar temas facilmente.
