---
title: Ecossistema
description: Projetos e integrações construídos com o Agence.
---

Uma coleção de projetos da comunidade construídos sobre o Agence.

:::note
Quer adicionar seu projeto relacionado ao Agence a esta lista? Envie um PR.
:::

Você também pode conferir [awesome-agence](https://github.com/awesome-opencode/awesome-agence) e [agence.cafe](https://agence.cafe), uma comunidade que agrega o ecossistema e a comunidade.
...
| Nome                                                                                               | Descrição                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Execute automaticamente sessões do Agence em sandboxes isoladas do Daytona com sincronização git e pré-visualizações ao vivo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Acompanhe o uso do Agence com Wakatime                                                                                       |
...
| [oh-my-agence](https://github.com/code-yeongyu/oh-my-agence)                                   | Agentes em segundo plano, ferramentas LSP/AST/MCP pré-construídas, agentes curados, compatível com Claude Code                 |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificações de desktop e alertas sonoros para sessões do Agence                                                             |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomeação automática de sessões Zellij com suporte de IA com base no contexto do Agence                                       |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permite que agentes do Agence carreguem prompts sob demanda com descoberta e injeção de habilidades                          |
...
| [@plannotator/agence](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisão de plano interativa com anotação visual e compartilhamento privado/offline                                             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estenda agence /commands em um poderoso sistema de orquestração com controle de fluxo granular                               |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificações nativas do OS para Agence – saiba quando as tarefas são concluídas                                              |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sem atrito para Agence                                                                                         |
...
| Nome                                                                                       | Descrição                                                                       |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot do Discord para controlar sessões do Agence, construído sobre o SDK       |
| [agence.nvim](https://github.com/NickvanDyke/agence.nvim)                              | Plugin Neovim para prompts cientes do editor, construído sobre a API            |
| [portal](https://github.com/hosenur/portal)                                                | UI web mobile-first para Agence sobre Tailscale/VPN                           |
| [agence plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template para construir plugins do Agence                                     |
| [agence.nvim](https://github.com/sudo-tee/agence.nvim)                                 | Frontend Neovim para Agence - um agente de codificação IA baseado em terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provedor Vercel AI SDK para usar Agence via @agence-ai/sdk                  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicativo Web / Desktop e Extensão do VS Code para Agence                    |
| [Agence-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian que incorpora Agence na UI do Obsidian                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Uma alternativa de código aberto ao Claude Cowork, alimentada pelo Agence     |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gerenciador de extensões Agence com perfis portáteis e isolados.              |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicativo Desktop, Web, Mobile e Cliente Remoto para Agence                  |
