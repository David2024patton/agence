...
description: Crie ferramentas que o LLM pode chamar no agence.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do agence, como `read`, `write` e `bash`.
