---
title: Compartilhar
description: Compartilhe suas conversas do agence.
---

O recurso de compartilhamento do agence permite que você crie links públicos para suas conversas do agence, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o agence:
...
O agence suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o agence usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
[Saiba mais](/docs/enterprise) sobre como usar o agence em sua organização.
