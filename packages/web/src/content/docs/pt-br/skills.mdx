...
As habilidades do agente permitem que o agence descubra instruções reutilizáveis do seu repositório ou diretório pessoal.
...
O agence pesquisa nesses locais:
...
Para caminhos locais do projeto, o agence sobe a partir do seu diretório de trabalho atual até alcançar a árvore de trabalho do git.
...
O agence lista as habilidades disponíveis na descrição da ferramenta `skill`.
