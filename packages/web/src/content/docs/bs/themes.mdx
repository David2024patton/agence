...
U Agence mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, Agence koristi nasu `agence` temu.
...
Agence dolazi sa vise ugradenih tema.
...
- Zele da Agence odgovara izgledu njihovog terminala
...
Agence podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
