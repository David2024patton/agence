...
Agent skills omogucavaju Agence da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Agence pretrazuje ove lokacije:
...
Za projektne lokalne putanje, Agence ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
Agence navodi dostupne skills u opisu `skill` alata.
