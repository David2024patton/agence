---
title: TUI
description: Korištenje korisničkog interfejsa Agence terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Agence pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Agence pokreće TUI za trenutni direktorij.
...
Kada koristite Agence TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Agence. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Agence. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo Agence čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `agence.default`.
