...
Agence Go je povoljna pretplata — **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno** — koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

Go radi kao bilo koji drugi provajder u Agence-u. Pretplatite se na Agence Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili Agence.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa Agence-om.
:::
...
Agence Go vam daje pristup ovim modelima za **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno**.

---

## Kako funkcioniše

Agence Go radi kao bilo koji drugi provajder u Agence-u.

1. Prijavite se na **<a href={console}>Agence Zen</a>**, pretplatite se na Go i
   kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI-ju, odaberite `Agence Go` i zalijepite
   svoj API ključ.
3. Pokrenite `/models` u TUI-ju da vidite listu modela dostupnih kroz Go.

:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na Agence Go.
:::
...
Agence Go uključuje sljedeća ograničenja:
...
[Model id](/docs/config/#models) u vašoj Agence konfiguraciji
...
Napravili smo Agence Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz Agence koristite i bilo kojeg drugog provajdera.
