---
title: Dodaci
description: Napišite vlastite dodatke za proširenje Agence.
---

Dodaci vam omogućavaju da proširite Agence spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja Agence.
...
Agence pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje Agence.
...
Spriječite agence da čita `.env` fajlove:
...
Dodaci također mogu dodati prilagođene alate u agence:
...
Pomoćnik `tool` kreira prilagođeni alat koji agence može pozvati. Uzima funkciju Zod sheme i vraća definiciju alata sa:

- `description`: Šta alat radi
- `args`: Zod šema za argumente alata
- `execute`: Funkcija koja se pokreće kada se pozove alat
  Vaši prilagođeni alati će biti dostupni za agence zajedno sa ugrađenim alatima.
...
Nivoi su: `debug`, `info`, `warn`, `error`. Pogledajte [SDK dokumentaciju](https://github.com/David2024patton/agence/docs/sdk) za detalje.
