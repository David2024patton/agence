...
Con Agence puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Agence usa nuestro propio tema `agence`.
...
Agence viene con varios temas integrados.
...
- Quiere que Agence coincida con la apariencia de su terminal
...
Agence admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
