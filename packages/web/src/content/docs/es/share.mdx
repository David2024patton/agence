---
title: Compartir
description: Comparte tus conversaciones Agence.
---

La función para compartir de Agence te permite crear enlaces públicos a tus conversaciones de Agence, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Agence:
...
Agence admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Agence usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
[Obtenga más información](/docs/enterprise) sobre el uso de agence en su organización.
