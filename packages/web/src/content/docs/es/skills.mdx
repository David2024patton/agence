...
Las habilidades del agente permiten a Agence descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Agence busca estas ubicaciones:
...
Para las rutas locales del proyecto, Agence sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
Agence enumera las habilidades disponibles en la descripción de la herramienta `skill`.
