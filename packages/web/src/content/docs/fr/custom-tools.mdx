...
description: Créez des outils que le LLM peut appeler dans agence.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de agence comme `read`, `write` et `bash`.
