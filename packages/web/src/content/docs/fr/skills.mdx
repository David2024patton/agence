...
Les compétences d'agent permettent à Agence de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
Agence recherche ces emplacements :
...
Pour les chemins locaux du projet, Agence remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
Agence répertorie les compétences disponibles dans la description de l'outil `skill`.
