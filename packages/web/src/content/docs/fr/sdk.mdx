---
title: SDK
description: Client JS de type sécurisé pour le serveur agence.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Le SDK agence JS/TS fournit un client de type sécurisé pour interagir avec le serveur.
Utilisez-le pour créer des intégrations et contrôler agence par programme.
...
console.log(`Server running at ${agence.server.url}`)
...
Si vous disposez déjà d'une instance en cours d'exécution de agence, vous pouvez créer une instance client pour vous y connecter :
...
```typescript
import type { Session, Message, Part } from "@agence-ai/sdk"
```
