...
Avec Agence, vous pouvez choisir parmi plusieurs thèmes intégrés, utiliser un thème qui s'adapte au thème de votre terminal ou définir votre propre thème personnalisé.

Par défaut, Agence utilise notre propre thème `agence`.
...
Agence est livré avec plusieurs thèmes intégrés.
...
- Vous souhaitez que Agence corresponde à l'apparence de leur terminal
...
Agence prend en charge un système de thèmes flexible basé sur JSON qui permet aux utilisateurs de créer et de personnaliser facilement des thèmes.
...
{
  "$schema": "https://github.com/David2024patton/agence/theme.json",
  "defs": {
    "nord0": "#2E3440",
    "nord1": "#3B4252",
    "nord2": "#434C5E",
