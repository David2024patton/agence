---
title: Share
description: Share your Agence conversations.
---

Agence's share feature allows you to create public links to your Agence conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Agence:
...
Agence supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Agence uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
[Learn more](/docs/enterprise) about using agence in your organization.
