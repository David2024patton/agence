...
Umiejętności agenta pozwalają agence odkryć instrukcje wielokrotnego użytku z repozytorium lub katalogu domowego.
...
agence przeszukuje te lokalizacje:
...
W przypadku ścieżek lokalnych projektu agence przechodzi od bieżącego katalogu roboczego, aż dotrze do drzewa roboczego git.
...
agence wymienia dostępne umiejętności w opisie narzędzia `skill`.
