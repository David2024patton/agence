---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące agence.
---

Funkcja udostępniania agence umożliwia tworzenie publicznych linków do konwersacji agence, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, agence:
...
agence obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie agence korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
[Dowiedz się więcej](/docs/enterprise) o używaniu agence w Twojej organizacji.
