...
Dzięki agence możesz wybrać jeden z kilku wbudowanych motywów, użyć motywu, który dostosowuje się do motywu terminala lub zdefiniować własny, niestandardowy motyw.

Domyślnie agence używa naszego własnego motywu `agence`.
...
agence ma kilka wbudowanych motywów.
...
- Chcą, aby Agence pasował do wyglądu ich terminala
...
agence obsługuje elastyczny system motywów oparty na JSON, który pozwala użytkownikom łatwo tworzyć i dostosowywać motywy.
