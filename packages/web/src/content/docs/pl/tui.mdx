---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala agence.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

agence zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie agence uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI agence, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do agence. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij agence. _Aliasy_: `/quit`, `/q`
...
- `leader_timeout` - Określa, jak długo Agence czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `agence.default`.
