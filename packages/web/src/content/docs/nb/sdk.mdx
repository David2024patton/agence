---
title: SDK
description: Typesikker JS-klient for Agence-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Agence JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Agence programmatisk.
...
Opprett en forekomst av Agence:
...
Hvis du allerede har en kjørende forekomst av Agence, kan du opprette en klientforekomst for å koble til den:
