...
Agentferdigheter lar Agence oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
agence søker etter disse stedene:
...
For prosjektlokale stier går agence opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
agence viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
