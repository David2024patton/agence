---
title: Ecosistema
description: Progetti e integrazioni costruiti con Agence.
---

Una raccolta di progetti della comunità costruiti su Agence.

:::note
Vuoi aggiungere il tuo progetto legato a Agence a questa lista? Apri una PR.
:::

Puoi anche dare un'occhiata a [awesome-agence](https://github.com/awesome-opencode/awesome-agence) e [agence.cafe](https://agence.cafe), una comunità che aggrega ecosistema e community.
...
| Nome                                                                                               | Descrizione                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Esegue automaticamente sessioni Agence in sandbox Daytona isolate con sync git e anteprime live |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Traccia l'uso di Agence con Wakatime                                                            |
...
| [oh-my-agence](https://github.com/code-yeongyu/oh-my-agence)                                   | Agenti in background, tool LSP/AST/MCP predefiniti, agenti curati, compatibile con Claude Code    |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifiche desktop e avvisi sonori per le sessioni Agence                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Naming automatico delle sessioni Zellij basato sul contesto Agence                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permette agli agenti Agence di caricare prompt al bisogno con discovery e injection di skill    |
...
| [@plannotator/agence](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisione interattiva dei piani con annotazione visiva e condivisione privata/offline             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estende agence /commands in un sistema di orchestrazione con controllo di flusso granulare      |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifiche native del sistema per Agence: sai quando i task finiscono                            |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git worktree senza attriti per Agence                                                           |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni Agence, costruito sull'SDK    |
| [agence.nvim](https://github.com/NickvanDyke/agence.nvim)                              | Plugin Neovim per prompt consapevoli dell'editor, costruito sull'API |
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per Agence su Tailscale/VPN                    |
| [agence plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin Agence                               |
| [agence.nvim](https://github.com/sudo-tee/agence.nvim)                                 | Frontend Neovim per agence: un agente di coding AI per terminale   |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare Agence tramite @agence-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per Agence                   |
| [Agence-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian che integra Agence nella UI di Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da Agence      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni Agence con profili portabili e isolati       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per Agence                |
