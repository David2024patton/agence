...
Le skill degli agenti permettono a Agence di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
Agence cerca in queste posizioni:
...
Per i percorsi locali al progetto, Agence risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
Agence elenca le skill disponibili nella descrizione dello strumento `skill`.
