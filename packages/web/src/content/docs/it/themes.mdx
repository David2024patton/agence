...
Con Agence puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, Agence usa il tema `agence`.
...
Agence include diversi temi integrati.
...
- Vuole che Agence corrisponda all'aspetto del terminale
...
Agence supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
