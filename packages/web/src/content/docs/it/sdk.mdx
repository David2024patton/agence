---
title: SDK
description: Client JS type-safe per il server agence.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di agence fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare agence in modo programmatico.
...
Se hai gia un'istanza di agence in esecuzione, puoi creare un client per collegarti:
