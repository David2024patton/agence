...
description: عميل JavaScript آمن الأنواع لخادم agence.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

توفر SDK الخاصة بـ agence لـ JS/TS عميلا آمنا للأنواع للتفاعل مع الخادم.
استخدمها لبناء التكاملات والتحكم في agence برمجيا.
...
إذا كان لديك مثيل agence يعمل بالفعل، يمكنك إنشاء مثيل عميل للاتصال به:
