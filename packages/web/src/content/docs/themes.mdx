...
With Agence you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, Agence uses our own `agence` theme.
...
Agence comes with several built-in themes.
...
- Want Agence to match their terminal's appearance
...
Agence supports a flexible JSON-based theme system that allows users to create and customize themes easily.
