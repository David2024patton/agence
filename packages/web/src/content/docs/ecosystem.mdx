---
title: Ecosystem
description: Projects and integrations built with Agence.
---

A collection of community projects built on Agence.

:::note
Want to add your Agence related project to this list? Submit a PR.
:::

You can also check out [awesome-agence](https://github.com/awesome-opencode/awesome-agence) and [agence.cafe](https://agence.cafe), a community that aggregates the ecosystem and community.
...
| Name                                                                                               | Description                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run Agence sessions in isolated Daytona sandboxes with git sync and live previews |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track Agence usage with Wakatime                                                                |
...
| [oh-my-agence](https://github.com/code-yeongyu/oh-my-agence)                                   | Background agents, pre-built LSP/AST/MCP tools, curated agents, Claude Code compatible            |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for Agence sessions                                      |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on Agence context                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow Agence agents to lazy load prompts on demand with skill discovery and injection           |
...
| [@plannotator/agence](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interactive plan review with visual annotation and private/offline sharing                        |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Extend agence /commands into a powerful orchestration system with granular flow control         |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for Agence – know when tasks complete                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for Agence                                                          |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control Agence sessions, built on the SDK       |
| [agence.nvim](https://github.com/NickvanDyke/agence.nvim)                              | Neovim plugin for editor-aware prompts, built on the API         |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Agence over Tailscale/VPN              |
| [agence plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building Agence plugins                           |
| [agence.nvim](https://github.com/sudo-tee/agence.nvim)                                 | Neovim frontend for agence - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using Agence via @agence-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for Agence             |
| [Agence-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds Agence in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by Agence |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Agence extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for Agence          |
