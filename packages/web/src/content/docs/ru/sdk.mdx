---
title: SDK
description: Типобезопасный JS-клиент для сервера agence.
---
...
Если у вас уже есть работающий экземпляр agence, вы можете создать экземпляр клиента для подключения к нему:
