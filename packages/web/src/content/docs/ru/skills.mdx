...
Навыки агента позволяют agence обнаруживать многократно используемые инструкции из вашего репозитория или домашнего каталога.
...
agence выполняет поиск в следующих местах:
...
Для локальных путей проекта agence переходит из вашего текущего рабочего каталога, пока не достигнет рабочего дерева git.
...
agence перечисляет доступные навыки в описании инструмента `skill`.
