---
title: SDK
description: agence sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

agence JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
agence'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Halihazırda çalışan bir agence örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
