...
description: agence dile özgü biçimlendiriciler kullanır.
---

agence, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

agence, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, agence bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

agence bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri agence yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
