...
agence ile birden fazla yerleşik tema arasından seçim yapabilir, terminal temanıza uyum sağlayan bir tema kullanabilir veya kendi özel temanızı tanımlayabilirsiniz.

Varsayılan olarak agence kendi `agence` temasını kullanır.
...
agence birden fazla yerleşik temayla gelir.
...
- agence'un terminal görünümüyle birebir uyumlu olmasını isteyenler
...
agence, kullanıcıların kolayca tema oluşturup özelleştirebilmesi için esnek bir JSON tabanlı tema sistemi sunar.
