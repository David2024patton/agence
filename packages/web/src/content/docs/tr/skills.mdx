...
Ajan becerileri, agence'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
Proje yerel yollarinda agence, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
...
agence, `skill` araci aciklamasinda mevcut becerileri listeler.
