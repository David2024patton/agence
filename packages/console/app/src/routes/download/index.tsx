          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://github.com/David2024patton/agence/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>agence.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g agence-ai")}>
                <code>
                  npm i -g <strong>agence-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g agence-ai")}>
                <code>
                  bun add -g <strong>agence-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/agence")}>
                <code>
                  brew install <strong>anomalyco/tap/agence</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S agence")}>
                <code>
                  paru -S <strong>agence</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
