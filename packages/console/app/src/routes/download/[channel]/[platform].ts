...
const downloadNames: Record<string, string> = {
  "darwin-aarch64-dmg": "Agence Desktop.dmg",
  "darwin-x64-dmg": "Agence Desktop.dmg",
  "windows-x64-nsis": "Agence Desktop Installer.exe",
...
export async function GET({ params: { platform, channel } }: APIEvent) {
  ...
  const resp = await fetch(
    `https://github.com/anomalyco/${channel === "stable" ? "agence" : "opencode-beta"}/releases/latest/download/${assetName}`,
  )
