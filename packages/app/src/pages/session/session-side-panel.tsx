...
import { Mark } from "@agence-ai/ui/logo"
import { DragDropProvider, DragDropSensors, DragOverlay, SortableProvider, closestCenter } from "@thisbeyond/solid-dnd"
import type { DragEvent } from "@thisbeyond/solid-dnd"
import type { SnapshotFileDiff, VcsFileDiff } from "@agence-ai/sdk/v2"
...
export function SessionSidePanel(props: {
  ...
  const shown = createMemo(
    () =>
      ...
      import.meta.env.VITE_AGENCE_CHANNEL !== "beta" ||
  ...
  return (
    <Show when={isDesktop() && !(import.meta.env.VITE_AGENCE_CHANNEL !== "prod" && !params.id)}>
      <aside
        id="review-panel"
