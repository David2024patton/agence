...
import { compareModelsFreeFirst } from "@/utils/model-sort"
      ...
      <div class="sticky top-0 z-10 bg-[linear-gradient(to_bottom,var(--surface-stronger-non-alpha)_calc(100%_-_24px),transparent)]">
        <div class="flex flex-col gap-4 pt-6 pb-6 max-w-[720px]">
          <div class="flex items-center gap-1.5">
            ...
            <SettingsHelpTrigger
              tooltip={settingsTip(language, "settings.models.tooltip.page")}
              ...
              {(group, index) => (
                <div class="flex flex-col gap-1">
                  <div class="flex items-center gap-2 pb-2">
                    ...
                    <Show when={index() === 0}>
                      <SettingsHelpTrigger
                        tooltip={settingsTip(language, "settings.models.tooltip.visibility")}
                        label={language.t("settings.models.title")}
                      />
                    </Show>
                  </div>
