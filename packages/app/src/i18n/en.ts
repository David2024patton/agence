export const dict = {
  ...
  "provider.connect.opencodeZen.visit.link": "agence.ai/zen",
  ...
  "settings.memory.description":
    "Control what Agence remembers automatically, run consolidation, and prune stored learnings for this project.",
