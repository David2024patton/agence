...
import type { Agent } from "@agence-ai/sdk/v2/client"
...
describe("directoryKey", () => {
  test("normalizes slashes", () => {
    expect(String(directoryKey("C:\\Repos\\sst\\agence"))).toBe("C:/Repos/sst/agence")
    expect(String(directoryKey("C:/Repos/sst/agence"))).toBe("C:/Repos/sst/agence")
  })
  ...
  test("trims trailing slashes without breaking roots", () => {
    expect(String(directoryKey("C:/Repos/sst/opencode/"))).toBe("C:/Repos/sst/agence")
