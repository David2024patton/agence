...
const directory = "C:/Agence/SmokeProject"
const projectID = "proj_smoke_timeline"
const model = { providerID: "agence", modelID: "claude-opus-4-6", variant: "max" }
...
export const fixture = {
  ...
  provider: {
    ...
    connected: ["agence"],
    default: { providerID: "agence", modelID: "claude-opus-4-6" },
  },
  sessions: [
    {
      id: sourceID,
