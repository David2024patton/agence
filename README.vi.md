...
nix run nixpkgs#agence           # hoặc github:David2024patton/agence cho nhánh dev mới nhất
```
...
Agence bao gồm hai agent được tích hợp sẵn mà bạn có thể chuyển đổi bằng phím `Tab`.
...
Tìm hiểu thêm về [agents](https://github.com/David2024patton/agence/docs/agents).

### Tài liệu

Để biết thêm thông tin về cách cấu hình Agence, [**hãy truy cập tài liệu của chúng tôi**](https://github.com/David2024patton/agence/docs).

### Đóng góp

Nếu bạn muốn đóng góp cho Agence, vui lòng đọc [tài liệu hướng dẫn đóng góp](./CONTRIBUTING.md) trước khi gửi pull request.
...
**Tham gia cộng đồng của chúng tôi** [Discord](https://discord.gg/agence) | [X.com](https://x.com/agence)
