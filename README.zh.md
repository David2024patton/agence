...
nix run nixpkgs#agence           # 或用 github:David2024patton/agence 获取最新 dev 分支
```
...
Agence 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://github.com/David2024patton/agence/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://github.com/David2024patton/agence/docs)。
...
**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=738j8655-cd59-4633-a30a-1124e0096789&qr_code=true) | [X.com](https://x.com/agence)
