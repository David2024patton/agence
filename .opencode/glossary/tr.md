...
- `Agence` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `agence` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Agence` in prose, `agence` only for exact technical identifiers
...
- Avoid changing `agence` to `Agence` inside commands, URLs, package names, or code literals
