...
- `Agence` (preserve casing in prose; keep `agence` only when it is part of commands, package names, paths, or code)
- `Agence Zen`
- `Agence CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `agence` in prose when referring to the product name; use `Agence`
