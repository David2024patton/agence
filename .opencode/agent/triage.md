...
Desktop application and browser-based app issues, including `agence web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core agence server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Agence Zen, Agence Go, and billing issues.
