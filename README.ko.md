...
nix run nixpkgs#agence           # 또는 github:David2024patton/agence 로 최신 dev 브랜치
```
...
Agence 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://github.com/David2024patton/agence/docs/agents) 에 대해 더 알아보세요.

### 문서

Agence 설정에 대한 자세한 내용은 [**문서**](https://github.com/David2024patton/agence/docs) 를 참고하세요.

### 기여하기

Agence 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.
...
**커뮤니티에 참여하기** [Discord](https://discord.gg/agence) | [X.com](https://x.com/agence)
