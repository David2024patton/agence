...
console.log("Fetching GitHub releases for anomalyco/agence...\n")
...
console.log("Fetching npm all-time downloads for agence-ai...\n")
const npmDownloads = await fetchNpmDownloads("agence-ai")
